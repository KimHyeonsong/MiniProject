...
var options = {
  //지도를 생성할 때 필요한 기본 옵션
  center: new kakao.maps.LatLng(37.55913150080453, 127.00536468132631), //지도의 중심좌표. 서울 한가운데
...
const dataSet = [
  {
    title: "돈돈돈까스",
    address: "서울특별시 중구 장충동2가 188-11",
    url: "https://youtu.be/b9eS5hbsV5w",
    category: "일식",
  },
  {
    title: "서울다이닝",
    address: "서울특별시 중구 장충동 190-10",
    url: "https://youtu.be/L2aanW7DqkA",
    category: "양식",
  },
  {
    title: "진아네떡볶이",
    address: "서울특별시 중구 퇴계로56길 52",
    url: "https://youtu.be/koQmU0V3AbU",
    category: "분식",
  },
];
